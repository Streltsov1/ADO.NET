...
namespace ConsoleApp3
{
    ...
    partial void DeleteCountry(Country instance);
		...
		public DataClasses2DataContext() : 
				base(global::ConsoleApp3.Properties.Settings.Default.LibraryConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnNameChanging(string value);
    partial void OnNameChanged();
    partial void OnPageNumbersChanging(int value);
    ...
    partial void OnAuthorIdChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PageNumbers", DbType="Int NOT NULL")]
		public int PageNumbers
		{
			...
			set
			{
				if ((this._PageNumbers != value))
				{
					this.OnPageNumbersChanging(value);
					this.SendPropertyChanging();
					this._PageNumbers = value;
					this.SendPropertyChanged("PageNumbers");
					this.OnPageNumbersChanged();
				}
			}
		}
